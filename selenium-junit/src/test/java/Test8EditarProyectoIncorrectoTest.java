...
public class Test8EditarProyectoIncorrectoTest {
  ...
  @Test
  public void test8EditarProyectoIncorrecto() throws InterruptedException {
    ...
    WebElement tituloConfiguracionDespues = wait.until(
        ExpectedConditions.visibilityOfElementLocated(
            By.xpath("//*[contains(text(),'Configuración del Proyecto')]")));

    assertEquals("Configuración del Proyecto", tituloConfiguracionDespues.getText());
  }
}