...
public class Test9EliminarProyectoCorrectoTest {
  ...
  @Test
  public void test9EliminarProyectoCorrecto() throws InterruptedException {
    WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));

    String nombreProyecto = "Proyecto Eliminar Selenium " + System.currentTimeMillis();
    ...
    WebElement tituloProyectosDespuesCrear = wait.until(
        ExpectedConditions.visibilityOfElementLocated(
            By.xpath("//*[contains(text(),'Proyectos Activos')]")));
    assertEquals("Proyectos Activos", tituloProyectosDespuesCrear.getText());
    ...
    List<WebElement> proyectoEliminado = driver.findElements(
        By.xpath("//h3[contains(text(),'" + nombreProyecto + "')]"));

    assertEquals("El proyecto descartado no debe aparecer en el listado de proyectos activos", 0,
        proyectoEliminado.size());
  }
}