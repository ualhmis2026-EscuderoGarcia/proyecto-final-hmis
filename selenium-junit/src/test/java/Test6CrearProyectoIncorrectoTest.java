...
public class Test6CrearProyectoIncorrectoTest {
  ...
  @Test
  public void test6CrearProyectoIncorrecto() throws InterruptedException {
    ...
    WebElement tituloCrearProyectoDespues = wait.until(
        ExpectedConditions.visibilityOfElementLocated(
            By.xpath("//*[contains(text(),'Registrar Nuevo Proyecto')]")));

    assertEquals("Registrar Nuevo Proyecto", tituloCrearProyectoDespues.getText());
  }
}